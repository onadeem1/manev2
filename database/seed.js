...
const users = seed(User, {
  omer: {
    ...
    phone: 5166439641,
    picture: 'https://scontent-lga3-1.xx.fbcdn.net/v/t1.0-9/14702480_10105493007974789_2631904228540268496_n.jpg?_nc_cat=0&oh=599631b805576120fbdad8d594ff64d1&oe=5B9F2F52',
    isAdmin: true,
  ...
  zain: {
    ...
    phone: 5162442916,
    picture: 'https://scontent-lga3-1.xx.fbcdn.net/v/t1.0-9/311871_10150451916788453_1159216794_n.jpg?_nc_cat=0&oh=557633b552f64369fc715260fe3d030d&oe=5BD8AD0D',
    isAdmin: true,
  ...
  zoby: {
    ...
    phone: 5166030254,
    picture: 'https://scontent-lga3-1.xx.fbcdn.net/v/t1.0-9/10426308_1163424637002509_6120123193537198820_n.jpg?_nc_cat=0&oh=9fd2a5386e262fa44711eec94ff4a7ca&oe=5BD127C8',
    isAdmin: true,
  ...
  danish: {
    ...
    phone: 5163766308,
    picture: 'https://scontent-lga3-1.xx.fbcdn.net/v/t1.0-9/25770_377372734835_2988176_n.jpg?_nc_cat=0&oh=9d81cd510df9ca585bd4e2066affdabb&oe=5BD0C7F6',
    isAdmin: false,
  ...
  maryam: {
    ...
    phone: 5168847563,
    picture: 'https://media.licdn.com/dms/image/C5603AQFU5dPN3Sj6cQ/profile-displayphoto-shrink_800_800/0?e=1536796800&v=beta&t=IATnUJlv_wKQRXlpKWhFBzW-zuETjRntuWRnFJBTl0I',
    isAdmin: false,
...
const places = seed(Place, {
  ...
  brooklynBridge: {
    googleId: 'EihCcm9va2x5biBCcmlkZ2UsIE5ldyBZb3JrLCBOWSAxMDAzOCwgVVNBIkgqRgoUChIJlenDaDpawokRDB4kyfcPdxYSFAoSCamlI_HwS8xMEWeVGN7Bxs_dGhgKCg3PwUEYFdRR5dMSCg2F_EIYFbtc5tM',
...
const challenges = seed(Challenge, ({ places }) => ({
...
const friendships = seed(Friendship, ({ users }) => ({
...
const recommendations = seed(Recommendation, ({ users, places, challenges }) => ({
  'raimos is amazing': {
  ...
  'the shed for brunch': {
    review: 'love the classic farm to table feel, old fashioneds w/ great breakfast makes this my second fav brunch spot on LI ',
    picture: 'https://cdn1.freshoffthegrid.com/wp-content/uploads/2016/05/Blackberry-Old-Fashioned-10.jpg',
    rating: 88,
    userId: users.maryam.id,
    placeId: places.theShed.id,
  ...
  'underground hip hop': {
    review: 'best place for underground hip hop but gets super crowded would recommend if your looking for 90s nostalgia',
  ...
  'brooklyn bridge walk': {
    review: "finally made the walk, i don't see what the fuss is all about, you do see some cool artists/weirdos but brooklyn is overrated",
    picture: 'https://brokelyn.com/app/uploads/2017/05/the-vantage-point-636776-unsplash-640x427.jpg',
    rating: 68,
    userId: users.zain.id,
    placeId: places.brooklynBridge.id,
  ...
  'jetty': {
    review: "nothing beats a beach day followed by drinks & apps at jetty, best atmosphere in LB, dylan gives it a 77 but he's become picky",
...
const userChallenges = seed(UserChallenge, ({ users, challenges }) => ({
  ...
  'maryam completes omer club challenge': {
    ...
    challengeId: challenges['dance at the club'].id,
    rating: 85,
    review: 'OMG this was like hearing a TRL playlist, just wish there was room to break it down :)',
    complete: true
  },
...
function seedEverything() {
  ...
  seeded.users = users();
  seeded.places = places();
  seeded.friendships = friendships(seeded);
  seeded.challenges = challenges(seeded);
  seeded.userChallenges = userChallenges(seeded);
  seeded.recommendations = recommendations(seeded);
